                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="container">
                        ...
                        <div class="mb-4 d-flex justify-content-between">
                            ...
                            <!-- div holding the export button and messages -->
                            <div>
                            ...
                            <!-- button for downloading template -->
                            <button class="btn btn-secondary" wire:click="export_template">
                                Download a template for Import
                            </button>
                            <!-- end of button for downloading template -->

                            <!-- div holding import button and messages -->
                            <div>
                        ...
                        <!-- end of div holding import button -->


                        <!-- below we have the search and order columns-->
                        <div class="row">
                        ...
                        <!-- table holding the stock information  -->
                        <x-table>
                            <x-slot name=header>
                        ...
                        <!-- end of table showing stock information-->
                        <div>
                            {!! $excel_content->links() !!}
                        </div>
                    </div>
